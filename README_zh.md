...
| Release 7 | `7d1b0f1` | [`release-7`](https://github.com/KevinWu8192/MinivLLM-Fixed/tree/release-7) | Qwen3-32B 配置、模型注册与 Large-scale Attention 集成 | [简体中文](releases/release-7_zh.md) · [English](releases/release-7.md) |
